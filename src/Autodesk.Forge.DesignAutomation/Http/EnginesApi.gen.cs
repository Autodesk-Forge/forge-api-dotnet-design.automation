...
namespace Autodesk.Forge.DesignAutomation.Http
{
    ...
    public interface IEnginesApi
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<Engine>> GetEngineAsync (string id, string scopes = null, IDictionary<string, string> headers = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ApiResponse<PageString>> GetEnginesAsync (string page = null, string scopes = null, IDictionary<string, string> headers = null);
    }
    ...
    public partial class EnginesApi : IEnginesApi
    {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Engine>> GetEngineAsync (string id, string scopes = null, IDictionary<string, string> headers = null)
        {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<PageString>> GetEnginesAsync (string page = null, string scopes = null, IDictionary<string, string> headers = null)
        {
            using (var request = new HttpRequestMessage())
            {
                request.RequestUri = 
