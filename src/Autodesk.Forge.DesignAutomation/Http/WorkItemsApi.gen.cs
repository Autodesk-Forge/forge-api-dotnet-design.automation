...
namespace Autodesk.Forge.DesignAutomation.Http
{
    ...
    public interface IWorkItemsApi
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<WorkItemStatus>> CreateWorkItemsAsync (WorkItem workitem, string scopes = null, IDictionary<string, string> headers = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<HttpResponseMessage> DeleteWorkitemsAsync (string id, string scopes = null, IDictionary<string, string> headers = null);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ApiResponse<WorkItemStatus>> GetWorkitemsStatusAsync (string id, string scopes = null, IDictionary<string, string> headers = null);
    }
    ...
    public partial class WorkItemsApi : IWorkItemsApi
    {
        ...
        public async System.Threading.Tasks.Task<ApiResponse<WorkItemStatus>> CreateWorkItemsAsync (WorkItem workitem, string scopes = null, IDictionary<string, string> headers = null)
        {
        ...
        /// <returns>Task of HttpResponseMessage</returns>
        public async System.Threading.Tasks.Task<HttpResponseMessage> DeleteWorkitemsAsync (string id, string scopes = null, IDictionary<string, string> headers = null)
        {
            using (var request = new HttpRequestMessage())
            {
                request.RequestUri = 
        ...
        public async System.Threading.Tasks.Task<ApiResponse<WorkItemStatus>> GetWorkitemsStatusAsync (string id, string scopes = null, IDictionary<string, string> headers = null)
        {
            using (var request = new HttpRequestMessage())
            {
                request.RequestUri = 
